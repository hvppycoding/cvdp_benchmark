...
- **Docker-Free Execution**: See [Docker-Free Execution Guide](DOCKER_FREE_EXECUTION.md) for running tests without Docker
...
- **[DOCKER_FREE_EXECUTION.md](DOCKER_FREE_EXECUTION.md)** - Guide for running tests without Docker (Korean/English)
